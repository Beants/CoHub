...
from ..config import RecruitingRuntimeConfig, load_recruiting_config
from ..models import NormalizedSearchQuery, SiteSearchResult
...
class LiepinService:
    ...
    async def _extract_candidates_with_retry(
        ...
        *,
        ...
        assert self._extract_candidates_from_page is not None
